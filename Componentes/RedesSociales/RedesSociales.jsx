    ...
    return(
        <section className="Redes">
            ...
            <div className="NilfiskBG py-4">
                ...
                <h2 className="RobotoBold numeroTelefono d-flex justify-content-center"><a className="d-flex align-items-center" href="tel:+56978511720"><div className="TelefonoImg me-4"><img src={logoTelefono} width={50} alt="Nilfisk" /></div>+569 7851 1720</a></h2>
            </div>
        </section>
    )
}
